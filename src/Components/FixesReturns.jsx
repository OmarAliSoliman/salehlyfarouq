...
class FixesReturns extends Component {
  ...
  async componentDidMount() {
    ...
    await axios
      .get(
        `http://sal7lly-001-site1.ctempurl.com/api/Orders/GetAllOrdersByStep?OrderSteps=12e7270a-d8c3-4451-4fa8-08d99d6e3e93${date == "" ? "" : `&date=${date}`}`
      )
      .then((res) => {
        // console.log(res);
        if (res.status === 200) {
      ...
      axios
      .get(
        "http://sal7lly-001-site1.ctempurl.com/api/Orders/GetAllOrdersByStep?OrderSteps=12e7270a-d8c3-4451-4fa8-08d99d6e3e93"
      )
      .then((res) => {
  ...
  render() {
    ...
    return (
      <div>
        <h5 class="mb-3 text-center font-weight-bold h4">مرتجع</h5>
